...
func init() {
	servicehub.Register("erda.collector.procrssor", &servicehub.Spec{
		Services:    []string{
			"erda.collector.procrssor-service",
		},
		Description: "here is description of erda.collector.procrssor",
